    ...
    $.flexslider = function (el, options) {
        ...
        methods = {
            init: function () {
                ...
                if (vars.controlsContainer !== '')
                    slider.controlsContainer =
                        ...
                        $(vars.controlsContainer);
                // MANUAL:
                if (vars.manualControls !== '')
                    slider.manualControls =
                        $(vars.manualControls).length > 0 &&
                        $(vars.manualControls);
            ...
            controlNav: {
                ...
                set: function () {
                    var selector =
                        vars.controlNav === 'thumbnails' ? 'img' : 'a';
                    slider.controlNav = $(
            ...
            if (!fade) {
                ...
                if (vars.animationLoop && !carousel) {
                    ...
                    slider.container
                        ...
                        .prepend(
                            slider.slides.last().clone().addClass('clone')
                        );
                }
        ...
        slider.doMath = function () {
            ...
            if (carousel) {
                ...
                slider.visible = Math.floor(
                    slider.w / (slider.itemW + slideMargin)
                );
                slider.move =
